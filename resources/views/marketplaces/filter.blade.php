...
@section('content')
        ...
        <div class="col2_left">
            @include('marketplaces.components.sidebar')
                                ...
                                <div class="panel-content" id="filtercontent">
                                    ...
                                    @foreach($filtercontent as $filter)
                                        <div class="panel-row">
                                            ...
                                            <a href="/marketplaces/{{$marketplace->id}}/filter/{{$current_modifier->id}}/delete/{{$filter['id']}}" class="btn btn-gray btn-small"><i class="glyphicon glyphicon-trash"></i></a>
                                        </div>
                                        <?php $i++; ?>
                                    @endforeach
                                    <a href="/marketplaces/{{$marketplace->id}}/filter/{{$current_modifier->id}}/add-and" class="btn btn-gray btn-small addand"><i class="glyphicon glyphicon-plus"></i> and</a>
                                ...
                                <div class="panel-content" id="filtercontent">
                                    ...
                                    @foreach($actioncontent as $action)
                                        <div class="panel-row">
                                            ...
                                            <a href="/marketplaces/{{$marketplace->id}}/action/{{$current_modifier->id}}/delete/{{$action['id']}}" class="btn btn-gray btn-small"><i class="glyphicon glyphicon-trash"></i></a>
                                        </div>
                                        <?php $i++; ?>
                                    @endforeach
                                    <a href="/marketplaces/{{$marketplace->id}}/action/{{$current_modifier->id}}/add-and" class="btn btn-gray btn-small addand"><i class="glyphicon glyphicon-plus"></i> and</a>
